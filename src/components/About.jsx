            ...
            <div className="text-gray-300 my-4">
              ...
              <div className="flex justify-start">
                <a
                  ...
                  className="relative inline-flex items-center px-8 py-3 overflow-hidden text-white border-2 rounded group focus:outline-none focus:ring hover:bg-red-800 hover:shadow-lg"
                  rel="noreferrer">
                ...
                <a
                  ...
                  className="relative inline-flex items-center px-8 py-3 overflow-hidden text-white border-2 rounded group focus:outline-none focus:ring ml-10 hover:bg-red-800 hover:shadow-lg"
                  rel="noreferrer">
                  <span className="absolute right-0 transition-transform translate-x-full group-hover:-translate-x-4">
                    <img src="https://api.iconify.design/emojione-v1:right-arrow.svg" alt="arrow" />
                  </span>
                  ...
                  <div className="relative mx-8 col-span-12 px-4 space-y-6 sm:col-span-9">
                    <div className="col-span-12 space-y-12 relative sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-700">
                      ...
                      <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-green-400">
                        <h3 className="text-xl font-semibold tracking-wide">arx.net S.A / OPAP S.A</h3>
